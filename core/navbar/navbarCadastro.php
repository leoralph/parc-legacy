        ...
        <div class="collapse navbar-collapse" id="navegacao">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a href="" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="bi bi-patch-plus"></i> Cadastro</a>
                    <ul class="dropdown-menu">
                        <li><a href="tipoChamado.php" class="dropdown-item">Tipo Chamado</a></li>
                </ul>
                </li>
                <li class="nav-item dropdown">
