            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="../php/cadastro/tipoChamado.php" class="dropdown-item">Tipo Chamado</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    <a href="usuarios.php" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="bi bi-people"></i> Usuários</a>
                    <ul class="dropdown-menu">
                        <li><a href="../php/usuarios/cadastrarUsuario.php" class="dropdown-item">Cadastrar/Alterar Usuário</a></li>
                        <li><a href="../php/usuarios/cadastrarGrupo.php" class="dropdown-item">Cadastrar/Alterar Grupo de Usuários</a></li>
                    </ul>
                </li>
            </ul>
