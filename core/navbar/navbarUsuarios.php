    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navegacao">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="../gerenciarChamados.php" class="nav-link"><i class="bi bi-gear"></i> Gerenciar chamados</a>
                </li>
                ...
                <li class="nav-item dropdown">
                    <a href="usuarios.php" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="bi bi-people"></i> Usuários</a>
                    <ul class="dropdown-menu">
                        <li><a href="cadastrarUsuario.php" class="dropdown-item">Cadastrar/Alterar Usuário</a></li>
                        <li><a href="cadastrarGrupo.php" class="dropdown-item">Cadastrar/Alterar Grupo de Usuários</a></li>
                    </ul>
                </li>
            </ul>
